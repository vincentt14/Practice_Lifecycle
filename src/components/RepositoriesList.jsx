    ...
    return (
      <div className="repositories-list">
        {this.state.repositories.map((repository) => {
          return <RepositoryItem key={`${repository.owner}/${repository.name}`} name={repository.name} owner={repository.owner} description={repository.description} url={repository.url} />;
        })}
      </div>
    );
  }
